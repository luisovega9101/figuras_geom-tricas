 ...
 * @author Luis Enrique
 */
public class TrianguloGrafico extends Triangulo implements Dibujable, Serializable{
    protected Color LineColor;
    protected Color BordeColor;

    public TrianguloGrafico(int x1, int y1, int x2, int y2, int x3, int y3, Color LineColor, Color BordeColor) throws ENoFigura{
