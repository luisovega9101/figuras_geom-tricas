 ...
 * @author Luis Enrique
 */
public class RectanguloGrafico extends Rectangulo implements Dibujable, Serializable{
    protected Color LineColor;
    protected Color BordeColor;

    public RectanguloGrafico(int x1, int y1, int x2, int y2, Color LineColor, Color BordeColor) throws ENoFigura{
        super(x1, y1, x2, y2);
