 ...
 * @author Luis Enrique
 */
public class ElipseGrafico extends Elipse implements Dibujable, Serializable{
    protected Color LineColor;
    protected Color BordeColor;

    public ElipseGrafico(int x, int y, int a, int b, Color LineColor, Color BordeColor) throws ENoFigura{
        super(x, y, a, b);
