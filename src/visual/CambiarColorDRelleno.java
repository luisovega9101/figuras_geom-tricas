...
/*
 * CambiarColorDRelleno.java
 *
 * Created on 22-jun-2011, 19:53:40
 */
 ...
 * @author Luis Enrique
 */
public class CambiarColorDRelleno extends javax.swing.JDialog {

    private cLienzo lienzo;
    private int pos;
    /** Creates new form CambiarColorDRelleno */
    public CambiarColorDRelleno(java.awt.Frame parent, boolean modal,cLienzo lienzo, int p) {
        super(parent, modal);
        initComponents();
        this.lienzo = lienzo;
        pos=p;
    ...
    private CambiarColorDRelleno(JFrame jFrame, boolean b) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CambiarColorDRelleno dialog = new CambiarColorDRelleno(new javax.swing.JFrame(), true);
