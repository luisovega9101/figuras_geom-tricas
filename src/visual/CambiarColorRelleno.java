 ...
 * @author Luis Enrique
 */
public class CambiarColorRelleno extends javax.swing.JFrame {

    /** Creates new form CambiarColorBorde */
    private Lienzo lienzo;
    private int pos;
    public CambiarColorRelleno(java.awt.Frame parent, boolean modal,Lienzo lienzo, int p) {
        initComponents();
        this.lienzo = lienzo;
        pos=p;
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(CambiarColorRelleno.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CambiarColorRelleno().setVisible(true);
            }
        });
    }
